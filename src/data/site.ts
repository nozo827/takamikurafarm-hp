...
export const soil = {
	...
	body: '私たちの小さな農園の根幹にあるのは、土地の循環です。私たちが大切にしているのは、作り手が主役になることではなく、土地の力をいかに引き出すか、という一点です。地域で集める落ち葉やもみ殻、手作りの堆肥や天然肥料を合わせ、地元の微生物の力を借りて整えた「和土（わど）」。この調和した土壌から、背伸びをせず、ゆっくりと時間をかけて育った作物には、土の記憶が宿ると信じております。',
};
